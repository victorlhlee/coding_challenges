...
// The function will take the num parameter being passed and return the factorial of it (ie. if num = 3, return 6).  For test cases, the range will be between 1 and 18.
